...
3. ```git@github.com:richdownie/cukehub_testathon.git``` How to [clone](https://help.github.com/articles/cloning-a-repository/) a git repository.
4. ```cd cukehub_testathon```
